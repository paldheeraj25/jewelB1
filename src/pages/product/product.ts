...
export class ProductPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public product: ProductProvider, public envProvider: EnvVarProvider, public modal: ModalController) {
  }
